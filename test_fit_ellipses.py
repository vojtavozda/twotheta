...
coeffs_012_cart = el.fit_ellipse(conic_012[0], conic_012[1])
coeffs_104_cart = el.fit_ellipse(conic_104[0], conic_104[1])
coeffs_110_cart = el.fit_ellipse(conic_110[0], conic_110[1])
coeffs_113_cart = el.fit_ellipse(conic_113[0], conic_113[1])

x012,y012 = el.get_ellipse_pts(el.cart_to_pol(coeffs_012_cart))
x104,y104 = el.get_ellipse_pts(el.cart_to_pol(coeffs_104_cart))
x110,y110 = el.get_ellipse_pts(el.cart_to_pol(coeffs_110_cart))
x113,y113 = el.get_ellipse_pts(el.cart_to_pol(coeffs_113_cart))
...
coeffs_012_prb_cart = el.fit_ellipse(conic_012_prb[0], conic_012_prb[1])
coeffs_104_prb_cart = el.fit_ellipse(conic_104_prb[0], conic_104_prb[1])
coeffs_110_prb_cart = el.fit_ellipse(conic_110_prb[0], conic_110_prb[1])
coeffs_113_prb_cart = el.fit_ellipse(conic_113_prb[0], conic_113_prb[1])

x012_prb,y012_prb = el.get_ellipse_pts(el.cart_to_pol(coeffs_012_prb_cart))
x104_prb,y104_prb = el.get_ellipse_pts(el.cart_to_pol(coeffs_104_prb_cart))
x110_prb,y110_prb = el.get_ellipse_pts(el.cart_to_pol(coeffs_110_prb_cart))
x113_prb,y113_prb = el.get_ellipse_pts(el.cart_to_pol(coeffs_113_prb_cart))
...
params = el.get_ellipse_from_general_cone(cone_apex,cone_axis,distance,two_theta)
